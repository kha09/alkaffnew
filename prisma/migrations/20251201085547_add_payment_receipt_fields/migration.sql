...
INSERT INTO "new_FormSubmission" ("agentId", "cityOfResidence", "contactNumber", "countryOfResidence", "email", "fullName", "id", "nationality", "orderStage", "preferredProgram", "programId", "submissionStatus", "submittedAt", "universityId", "userId") SELECT "agentId", "cityOfResidence", "contactNumber", "countryOfResidence", "email", "fullName", "id", "nationality", "orderStage", "preferredProgram", "programId", "submissionStatus", "submittedAt", "universityId", "userId" FROM "FormSubmission";
