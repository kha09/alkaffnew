...
CREATE TABLE "new_FormSubmission" (
    ...
    "visaDocumentsUploadedAt" DATETIME,
...
INSERT INTO "new_FormSubmission" ("agentId", "canUploadReceipt", "cityOfResidence", "contactNumber", "countryOfResidence", "email", "fullName", "id", "nationality", "orderStage", "paymentReceiptPath", "preferredProgram", "programId", "receiptUploadedAt", "receiptViewedByAdmin", "submissionStatus", "submittedAt", "universityId", "userId") SELECT "agentId", "canUploadReceipt", "cityOfResidence", "contactNumber", "countryOfResidence", "email", "fullName", "id", "nationality", "orderStage", "paymentReceiptPath", "preferredProgram", "programId", "receiptUploadedAt", "receiptViewedByAdmin", "submissionStatus", "submittedAt", "universityId", "userId" FROM "FormSubmission";
