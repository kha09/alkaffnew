...
export default function CommissionsPage() {
  ...
  const handleCreateCommission = async () => {
    try {
      ...
      if (!newCommission.agentId || !newCommission.orderId || !newCommission.amount) {
        toast({
          title: "خطأ",
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    id="orderId"
                    type="number"
                    value={newCommission.orderId || ''}
                    onChange={(e) => setNewCommission({...newCommission, orderId: parseInt(e.target.value) || null})}
