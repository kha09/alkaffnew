...
export default function CommissionsPage() {
    ...
    try {
      ...
      setCommissions(commissions.map(commission => 
        commission.id === commissionId 
          ? { ...commission, status: "approved", approvedAt: new Date().toISOString() } 
          : commission
      ))
      toast({
        title: "نجاح",
      ...
      toast({
        title: "خطأ",
        description: "حدث خطأ أثناء الموافقة على طلب العمولة",
        variant: "destructive",
      })
    }
  }
  ...
  const handlePayCommission = async (commissionId: number) => {
    try {
      ...
      toast({
        title: "خطأ",
        description: "حدث خطأ أثناء دفع العمولة",
        variant: "destructive",
      })
    }
  }
  ...
  const handleRejectCommission = async (commissionId: number) => {
    try {
      ...
      toast({
        title: "خطأ",
        description: "حدث خطأ أثناء رفض طلب العمولة",
        variant: "destructive",
      })
    }
  }
  ...
  const handleCreateCommission = async () => {
    try {
      ...
      const newCommissionObj: Commission = {
        ...
        agent: agents.find(a => a.id === newCommission.agentId) || agents[0],
      ...
      toast({
        title: "خطأ",
        description: "حدث خطأ أثناء إنشاء العمولة",
        variant: "destructive",
      })
    }
  }
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      {/* Mock students data - in real implementation, this would be filtered by selected agent */}
                      <SelectItem value="1">أحمد علي</SelectItem>
                      <SelectItem value="2">سارة محمد</SelectItem>
                      <SelectItem value="3">خالد سعيد</SelectItem>
                      <SelectItem value="4">فاطمة أحمد</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div>
